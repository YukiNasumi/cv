...
echo 1 epoch
python train.py --save_path model_d5/model1.pth --train True --train_path /hy-tmp/data/data5/train
...
echo
echo 2 epoch
python train.py --save_path model_d5/model2.pth --train True --train_path /hy-tmp/data/data5/train --epoch 2
echo test it on test data 5,6,7,8
...
echo 1 epoch
python train.py --save_path model_d8/model1.pth --train True --train_path /hy-tmp/data/data8/train
echo test it on test data 5,6,7,8
...
echo 2 epoch
python train.py --save_path model_d8/model2.pth --train True --train_path /hy-tmp/data/data8/train --epoch 2
echo test it on test data 5,6,7,8
